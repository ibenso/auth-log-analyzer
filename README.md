...
The analyzer detects suspicious activity such as brute-force attempts, invalid user logins, night-time activity, and successful logins — and generates a clean, structured security report.
